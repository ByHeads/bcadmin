...
- Pretty much everything you can do in [bcman](https://docs.heads.com/broadcaster/e/applications/broadcaster-manager)
...
- Store connection credentials, no more copy-pasting API keys and URLs on each connection
